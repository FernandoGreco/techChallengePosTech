...
describe('OrdensServicoController', () => {
  ...
  it('consultarStatus chama useCase.consultarStatus', async () => {
    ...
    await expect(controller.consultarStatus('o1')).resolves.toEqual({
      status: 'PENDENTE',
    });
  ...
  it('adicionarServico chama useCase.adicionarServico', async () => {
    ...
    await expect(controller.adicionarServico('o1', dto)).resolves.toEqual({
      success: true,
    });
  ...
  it('adicionarPeca chama useCase.adicionarPeca', async () => {
    ...
    await expect(controller.adicionarPeca('o1', dto)).resolves.toEqual({
      success: true,
    });
  ...
  it('iniciarDiagnostico chama useCase.iniciarDiagnostico', async () => {
    ...
    await expect(controller.iniciarDiagnostico('o1')).resolves.toEqual({
      success: true,
    });
  ...
  it('registrarDiagnostico chama useCase.registrarDiagnostico', async () => {
    ...
    await expect(controller.registrarDiagnostico('o1', dto)).resolves.toEqual({
      success: true,
    });
  ...
  it('gerarOrcamento chama useCase.gerarOrcamento', async () => {
    ...
    await expect(controller.gerarOrcamento('o1')).resolves.toEqual({
      success: true,
    });
  ...
  it('aprovarOrcamento chama useCase.aprovarOrcamento', async () => {
    ...
    await expect(controller.aprovarOrcamento('o1')).resolves.toEqual({
      success: true,
    });
  ...
  it('recusarOrcamento chama useCase.recusarOrcamento', async () => {
    ...
    await expect(controller.recusarOrcamento('o1')).resolves.toEqual({
      success: true,
    });
  ...
  it('iniciarExecucao chama useCase.iniciarExecucao', async () => {
    ...
    await expect(controller.iniciarExecucao('o1')).resolves.toEqual({
      success: true,
    });
  ...
  it('finalizar chama useCase.finalizar', async () => {
    ...
    await expect(controller.finalizar('o1')).resolves.toEqual({
      success: true,
    });
